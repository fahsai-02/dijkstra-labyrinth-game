...
public class MonsterStatus {
    ...
    static {
        // Stage 1
        monsterData.put("Glorbo", new MonsterStatus("Glorbo Frutodrilo", 50, 10, 0, 40, "assets/Monster/Glorbo-Frutodrilo.PNG"));
        monsterData.put("Tralalero", new MonsterStatus("Tralalero Tralala", 40, 10, 5, 45,"assets/Monster/Tralalero-Tralala.PNG"));
        monsterStageMap.put(1, Arrays.asList("Glorbo", "Tralalero"));

        // Stage 2
        monsterData.put("Shimpanzini", new MonsterStatus("Shimpanzini Bananinni", 60, 8, 2, 80, "assets/Monster/Shimpanzini-Bananinni.PNG"));
        monsterData.put("Balerinna", new MonsterStatus("Balerinna Cappuccinna", 70, 5, 8, 90, "assets/Monster/Balerinna-Cappuccinna.PNG"));
        monsterData.put("Fruli", new MonsterStatus("Fruli Frulla", 50, 22, 10, 100, "assets/Monster/Fruli-Frulla.PNG"));
        monsterStageMap.put(2, Arrays.asList("Shimpanzini", "Balerinna", "Fruli"));

        // Stage 3
        monsterData.put("Trulmero", new MonsterStatus("Trulmero Trulicina", 100, 15, 0, 120, "assets/Monster/Trulmero-Trulicina.PNG"));
        monsterData.put("Saturno", new MonsterStatus("La Vaca Saturno Saturnita", 140, 17, 4, 150 ,"assets/Monster/La-Vaca-Saturno-Saturnita.PNG"));
        monsterData.put("Cappuccino", new MonsterStatus("Cappuccino Assasino", 130, 20, 7, 250, "assets/Monster/Cappuccino-Assasino.PNG"));
        monsterData.put("Burbaloni", new MonsterStatus("Burbaloni Lulioli", 110, 13, 12, 130, "assets/Monster/Burbaloni-Lulioli.PNG"));
        monsterData.put("Brr", new MonsterStatus("Brr Brr Patapim", 150, 30, 15, 200, "assets/Monster/Brr-Brr-Patapim.PNG"));
        ...
        // Boss
        monsterData.put("Tung", new MonsterStatus("Tung Tung Tung Sahur", 1000, 105, 20, 1_000_000, "assets/Monster/BOSS.PNG"));
    }
